...
November 20256From Predictive AI to 
Autonomous Agents
...
combines a Language Model's (LM) ability to reason  with the practical ability to act , allowing Agents are the natural evolution 
of Language Models, made useful 
in software.

November 20257it to handle complex, multi-step tasks that a model alone cannot. The critical capability is that 
...
November 20258Words are insufficient to describe how humans interact with AI. We tend to 
...
November 20259Chain-of-Thought4 or ReAct5) to break down complex goals into steps and decide when 
...
November 202510critical components: domain expertise, a defined personality, and seamless integration 
...
November 202511At its core, an agent operates on a continuous, cyclical process to achieve its objectives. 
...
November 202512This "Think, Act, Observe" cycle continues - managed by the Orchestration Layer , reasoned 
...
November 202513Instead of immediately acting, the agent first enters its "Think It Through" phase to devise a 
...
November 202514A Taxonomy of Agentic Systems
...
November 202515Level 0: The Core Reasoning System
...
how to approach solving a problem with great depth. The trade-off is a complete lack of realtime awareness; it is functionally "blind" to any event or fact outside its training data. 
...
November 202516This fundamental ability to interact with the world - whether using a search tool for a score , 
...
November 202517• Act:  Call the google_places  tool with query="coffee shop in Millbrae, CA", 
...
At the highest level, the paradigm shifts entirely. We move away from building a single, allpowerful "super-agent" and toward a "team of specialists" working in concert, a model that 
...
November 2025183. Delegates to WebDevAgent:  "Generate the new product page HTML based on the 
...
November 202519Core Agent Architecture: Model, Tools, 
and Orchestration
...
November 202520You may choose more than one model, a "team of specialists." You don't use a sledgehammer 
...
more cost-effective model like Gemini 2.5 Flash . Model routing might be automatic or hardcoded but is a key strategy for optimizing both performance and cost9.
...
November 202521Here are a few of the main types of tools agent builders will put into the “hands” of 
...
The most foundational tool is the ability to access up-to-date information. RetrievalAugmented Generation (RAG)  gives the agent a "library card" to query external knowledge, 
...
November 202522This also includes tools for human interaction. An agent can use a Human in the Loop 
...
November 202523Core Design Choices
...
November 202524Here, you tell it, You are a helpful customer support agent for Acme Corp, ...  
...
November 202525segmented into discrete sub-tasks, and each is assigned to a dedicated, specialized AI agent. 
...
November 202526quality standards. For high-stakes tasks, the Human-in-the-Loop (HITL)  pattern is critical, 
...
November 202528The transition from traditional, deterministic software to stochastic, agentic systems requires 
...
November 202529Measure What Matters: Instrumenting Success Like an 
A/B Experiment
...
November 202530reviewed by a domain expert before being accepted as valid. Increasingly, the curation and 
...
November 202531overviews of performance. Trace data can be seamlessly collected in platforms like Google 
...
Human feedback is not an annoyance to be dealt with; it is the most valuable and datarich resource you have for improving your agent. When a user files a bug report or clicks 
...
November 202532Agents and Humans
...
November 202533This opens up a vast array of use cases that are simply impossible with text, from a 
...
November 202534Agents and Money
...
November 202535and sensitive data disclosure . You want to give your agent a leash long enough to do its 
...
by techniques like prompt injection33. Instead, the best practice is a hybrid, defense-indepth approach .34 The first layer consists of traditional, deterministic guardrails —a set of 
...
November 202536Identity is distinct from the identity of the user who invoked it and the developer who built it. 
...
Table 1: A non-exhaustive example of different categories of actors for authenticationPrincipal entity Authentication / Verification Notes
Users Authenticated with OAuth 
or SSOHuman actors with full 
autonomy and responsibility for 
their actions
Agents (new category of 
principles )Verified with SPIFFE Agents have delegated 
...
November 202537Policies to Constrain Access
...
November 202538For more dynamic security that can adapt to the agent's runtime behavior, ADK provides 
...
November 202540they create a new, complex network of interactions, data flows, and potential security 
...
Managing this requires moving beyond securing individual agents to implementing a higherorder architectural approach: a central gateway that serves as a control plane for all 
agentic activity.

November 202541Imagine a bustling metropolis with thousands of autonomous vehicles—users, agents, and 
...
November 202542Cost and Reliability: The Infrastructure Foundation
...
November 202543How agents learn and self evolve
...
• Enhanced Context Engineering: The system continuously refines its prompts, fewshot examples, and the information it retrieves from memory. By optimizing the context 
...
November 202544Example: Learning New Compliance Guidelines
...
November 202546Simulation and Agent Gym - the next frontier
...
possible, and pressure test the agent (this can include advance techniques, such as redteaming, dynamic evaluation and a family of critiquing agents)
...
5. Finally, even constructs such as Agent Gym, may not be able to overcome certain edgecase (due to the well known problem of ‘tribal knowledge’ in the enterprise). In those cases 
...
November 202547Examples of advanced agents
Google Co-Scientist
...
November 202548Think of the system as a research project manager. The AI first takes a broad research 
...
November 202549AlphaEvolve Agent
...
November 202550AlphaEvolve is designed for a deep, iterative partnership between humans and AI. This 
...
November 20255318. https://google.github.io/adk-docs/
...
November 20255438. https://google.github.io/adk-docs/callbacks/design-patterns-and-best-practices  
